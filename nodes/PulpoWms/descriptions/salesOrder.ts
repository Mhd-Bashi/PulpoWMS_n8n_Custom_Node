	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				typeOptions: { loadOptionsMethod: 'getWarehouses' },
				default: '',
				description: 'Destination warehouse for transfers. Choose from the list, or specify an ID using an expression. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				typeOptions: { loadOptionsMethod: 'getWarehouses' },
				default: '',
				description: 'Source warehouse. Choose from the list, or specify an ID using an expression. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
			},
		],
	},
